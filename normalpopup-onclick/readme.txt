...
For testing the examples with actual calls, you need to edit normalpopup-onclick.js file and replace xxxxxx with actual values for the following variables. 
